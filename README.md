...
#### Index other `.env` files can be used?
...
```sh
    ...
    ? Index Firebase project do you want to associate as default? Example app (example-app-fd690)
    ...
    ? Index file should be used for Database Rules? database.rules.json
    ...
    ? Index do you want to use as your public directory? build
